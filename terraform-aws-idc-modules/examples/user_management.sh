...
show_help() {
  ...
  echo "  --policy-type TYPE                Policy type (AWS_MANAGED, CUSTOMER_MANAGED, INLINE)"
  ...
  echo "  $0 --action create_permission_set --permission-set-name developer-access --policy-type AWS_MANAGED --policy-name PowerUserAccess"
